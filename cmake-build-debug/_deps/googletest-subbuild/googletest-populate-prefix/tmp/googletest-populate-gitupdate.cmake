...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "release-1.12.1"
  WORKING_DIRECTORY "D:/Labs/labwork2-Mihail-mm/cmake-build-debug/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Labs/labwork2-Mihail-mm/cmake-build-debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Labs/labwork2-Mihail-mm/cmake-build-debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
